...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `failed` | `False` | `False` | 0 | 0 | 0 | None | FileNotFoundError: [Errno 2] No such file or directory: '<repo>\\experiments\\multi_agent\\orchestrator_executor\\bounded_stress_candidate_pairs_v1\\second_model__first_model\\strict_cpu\\concurrency_1\\group_runs\\run_001\\runs\\trial_001\\workspace\\office_agent_1_executor_note.md' |
