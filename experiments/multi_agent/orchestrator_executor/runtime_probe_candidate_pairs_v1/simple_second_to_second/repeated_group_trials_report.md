...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.887415 |  |
| `trial_002` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.887214 |  |
| `trial_003` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.88726 |  |

## 6. Aggregate metrics

- mean_pair_quality_score: `0.887296`
- std_pair_quality_score: `8.6e-05`
