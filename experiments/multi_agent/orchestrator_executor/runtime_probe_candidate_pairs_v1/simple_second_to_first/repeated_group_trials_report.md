...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.890001 |  |
| `trial_002` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.889801 |  |
| `trial_003` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.89004 |  |

## 6. Aggregate metrics

- mean_pair_quality_score: `0.889947`
- std_pair_quality_score: `0.000105`
