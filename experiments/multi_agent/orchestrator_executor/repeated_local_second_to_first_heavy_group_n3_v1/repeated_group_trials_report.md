...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed` | `True` | `True` | 8 | 8 | 8 | 0.94576 |  |
| `trial_002` | `completed` | `True` | `True` | 8 | 8 | 8 | 0.946438 |  |
| `trial_003` | `completed` | `True` | `True` | 8 | 8 | 8 | 0.946309 |  |

## 6. Aggregate metrics

- mean_pair_quality_score: `0.946169`
- std_pair_quality_score: `0.000294`
