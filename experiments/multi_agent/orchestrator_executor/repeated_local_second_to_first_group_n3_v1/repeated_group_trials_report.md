...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.890435 |  |
| `trial_002` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.890503 |  |
| `trial_003` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.890646 |  |

## 6. Aggregate metrics

- mean_pair_quality_score: `0.890528`
- std_pair_quality_score: `8.8e-05`
