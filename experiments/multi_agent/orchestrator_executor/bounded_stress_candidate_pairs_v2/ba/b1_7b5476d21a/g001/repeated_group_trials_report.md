...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed_with_failures` | `False` | `True` | 11 | 5 | 5 | 0.78125 | validation_failed: write_path_outside_artifact_workspace; HTTPStatusError: Client error '400 Bad Request' for url 'http://127.0.0.1:8082/v1/chat/completions'
...
- mean_pair_quality_score: `0.78125`
