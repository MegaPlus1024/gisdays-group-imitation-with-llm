...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed_with_failures` | `False` | `True` | 8 | 0 | 0 | 0.14407 | HTTPStatusError: Server error '500 Internal Server Error' for url 'http://127.0.0.1:8082/v1/chat/completions'
...
- mean_pair_quality_score: `0.14407`
