...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed_with_failures` | `False` | `True` | 9 | 7 | 7 | 0.875178 | NextActionValidationError: Next-action JSON failed schema validation: 1 validation error for NextAction
expected_result
...
- mean_pair_quality_score: `0.875178`
