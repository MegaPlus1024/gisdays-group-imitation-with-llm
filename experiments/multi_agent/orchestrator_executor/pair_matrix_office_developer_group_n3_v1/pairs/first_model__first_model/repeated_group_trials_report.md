...
- orchestrator: `first_model` / Qwen2.5 3B Instruct Q4_K_M
...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `failed` | `False` | `False` | 0 | 0 | 0 | 0.0 | orchestrator_plan_parse_failed: Invalid orchestrator JSON output: Expecting value: line 1 column 1 (char 0) |
| `trial_002` | `failed` | `False` | `False` | 0 | 0 | 0 | 0.0 | orchestrator_plan_parse_failed: Invalid orchestrator JSON output: Expecting value: line 1 column 1 (char 0) |
| `trial_003` | `failed` | `False` | `False` | 0 | 0 | 0 | 0.0 | orchestrator_plan_parse_failed: Invalid orchestrator JSON output: Expecting value: line 1 column 1 (char 0) |
