...
|---|---|---|---|---:|---:|---:|---:|---|
| `trial_001` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.88784 |  |
| `trial_002` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.887587 |  |
| `trial_003` | `completed` | `True` | `True` | 2 | 2 | 2 | 0.887792 |  |

## 6. Aggregate metrics

- mean_pair_quality_score: `0.88774`
- std_pair_quality_score: `0.00011`
