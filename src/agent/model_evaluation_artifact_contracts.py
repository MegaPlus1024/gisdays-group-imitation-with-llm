...
_CONTRACTS_BY_TYPE: dict[str, ArtifactSchemaContract] = {
    ...
    MODEL_PAIR_EXECUTION_READINESS_SUMMARY: _contract(
        MODEL_PAIR_EXECUTION_READINESS_SUMMARY,
        required=(
            _field("schema_version", "string"),
            _field("status", "string"),
            _field("allow_runtime_execution", "boolean"),
            _field("trial_count", "integer"),
            _field("ready_trial_count", "integer"),
            _field("not_ready_trial_count", "integer"),
            _field("model_pair_count", "integer"),
            _field("scenario_count", "integer"),
            _field("findings", "array"),
            _field("warnings", "array"),
            _field("notes", "array"),
            _field("no_runtime_execution", "boolean"),
        ),
