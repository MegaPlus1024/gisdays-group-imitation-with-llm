...
- Phase 12E2 records repeated hard-trials variance evidence in `docs/status/phase_12e_repeated_hard_trials.md`; it compares `second_model` vs `third_model` offline and does not add live model or browser execution.
