...
def test_build_version_payload_includes_subcommands() -> None:
    ...
    assert registry.MODEL_PAIR_EXECUTION_READINESS_SUMMARY in payload["artifact_contract_supported_types"]
...
def test_build_version_payload_includes_schema_versions_from_registry() -> None:
    ...
    assert "model_pair_execution_readiness_v1" in payload["supported_schema_versions"]
