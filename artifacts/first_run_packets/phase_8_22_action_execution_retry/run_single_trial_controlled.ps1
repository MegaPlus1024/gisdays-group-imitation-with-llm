...
.\.venv\Scripts\python.exe scripts/run_single_trial_controlled.py `
  --plan artifacts/first_run_packets/phase_8_22_action_execution_retry/model_pair_plan.json `
  --readiness-summary artifacts/first_run_packets/phase_8_22_action_execution_retry/model_pair_execution_readiness_summary.json `
  --entrypoint src.agent.model_pair_local_pipeline_entrypoint:run_local_model_pair_trial `
  --local-pipeline-config artifacts/first_run_packets/phase_8_22_action_execution_retry/local_pipeline_config.json `
  --output-dir artifacts/single_trial_runs/phase_8_22_action_execution_retry `
  ...
  --run-id phase_8_22_action_execution_retry `
