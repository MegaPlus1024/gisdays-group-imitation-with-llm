...
.\.venv\Scripts\python.exe scripts/run_single_trial_controlled.py `
  ...
  --local-pipeline-config artifacts/first_run_packets/phase_8_26_mini_matrix_r3/local_pipeline_config.r01.json `
  --output-dir artifacts/single_trial_runs/phase_8_26_mini_matrix_r1 `
  ...
  --run-id phase_8_26_mini_matrix_r1 `
